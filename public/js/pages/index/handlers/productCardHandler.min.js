function productCardHandler() {
    ...
    Array.from(prCards).forEach((productCard) => {
        ...
        buttonWeightHandler(weightButtons, priceForWeight, node_weights, buttonAddValue, st);

        buttonAddProductToCartHandler(buttonAdd, weightButtons, productName, selectedProducts, st);
    });
    //menu handler
